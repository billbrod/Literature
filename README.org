...
* Set-up
  ...
  will need to change the paths in literature.el
  ...
  Mendeley, see [[http://support.mendeley.com/customer/portal/articles/227951-how-do-i-locate-mendeley-desktop-database-files-on-my-computer-][here]] for details) and a bibtex file (exported from
  Mendeley, select all files and press Ctrl+e) with all the files you
  want to move over. It's recommended that you use a copy of your
